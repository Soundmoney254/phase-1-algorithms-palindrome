...
/*
  ...
  Once the reversedWord variable contains a string that has gone through the above processes I used an if statement to check if the input ""word" is equal to the "reversedWord".
    If they are equal the if statement returns true and else if they are not equal it returns false.
*/
